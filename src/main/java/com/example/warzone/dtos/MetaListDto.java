...
public class MetaListDto {
    ...
    public MetaListDto(Long id, String name, String range, String gun1, String category, String attachment_1, String attachment_2, String attachment_3, String attachment_4, String attachment_5) {
        this.id = id;
        this.name = name;
        this.range = range;
        this.gun1 = gun1;
